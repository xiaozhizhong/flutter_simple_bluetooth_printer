...
@objc public protocol BluetoothDelegate : NSObjectProtocol {
    ...
    */
    ...
    @objc optional func didWriteValueForCharacteristic(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic)
    
    @objc optional func didFailToWriteValueForCharacteristic(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: Error)
}
