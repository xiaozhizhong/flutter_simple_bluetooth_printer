    ...
    */
    ...
    public func peripheral(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: Error?){
        if error != nil{
            ...
            delegate?.didFailToWriteValueForCharacteristic?(peripheral, didWriteValueFor: characteristic, error: error!)
        }else{
            delegate?.didWriteValueForCharacteristic?(peripheral, didWriteValueFor: characteristic)
        }
    }
